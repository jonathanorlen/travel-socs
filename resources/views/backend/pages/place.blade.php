    ...
    <section class="section">
        <div class="section-header">
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item active">Place</div>
            </div>
        </div>
            ...
            <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="card">
                    <div class="row pl-4 pr-4 pt-4">
                        ...
                        <div class="col-6 col-sm-6 col-xs-6 col-md-6 col-lg-6">
                            <a href="{{route('place-create')}}" class="btn btn-icon btn-lg btn-primary float-right"><i
                                    class="far fa-edit"></i>
                                Create
                            </a>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ ++$index }}</td>
                                        <td><img src="{{ url('images/place/'.$item->picture) }}" alt="" width="120px"></td>
                                        <td>{{ $item->name }}</td>
                                        <td>
                                            ...
                                            <button data-confirm="Realy?|Do you want to continue to delete this data?"
                                                data-confirm-yes="window.location ='{{route('place-delete',$item->id)}}'"
